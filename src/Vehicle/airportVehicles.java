...
/**
 * Servlet implementation class airportVehicles
 */
@WebServlet("/airportVehicles")
public class airportVehicles extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public airportVehicles() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		out.print("<title>Airport rent vehicles");
		out.print("</title>");
		...
		out.print("<h1>Display the records of Vehicles for AIRPORT tours</h1>");
		out.print("<table border='1'style='color:blue;background-color: powderblue;width:60%;font-size: 30px;'><tr style='color:red;font-size: 30px;'>"
				+ "<th>Vehicle ID</th>" + "<th>Type</th>"
				+ "<th>Cost Per Day</th>" + "<th>Cost Per KM</th>"
				+ "<th>Image Name</th>" + "<th>Rent Category</th>"
				+ "<th>Image</th>" + "</tr>");
		try {
			...
			String sql = "select * from rentVehicles where rentCategory='air-port'";
