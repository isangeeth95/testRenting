...
/**
 * Servlet implementation class weddingVehicles
 */
@WebServlet("/weddingVehicles")
public class weddingVehicles extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public weddingVehicles() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		out.print("<title>Wedding rent vehicles");
		out.print("</title>");
		...
		out.print("<h1>Display the records of Vehicles for WEDDING tours</h1>");
		...
		try {
			...
			String sql = "select * from rentVehicles where rentCategory='wedding'";
