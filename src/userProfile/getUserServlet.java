...
public class getUserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = "select fname,lname,email,gender,country,city,telNo,uname,password,imageName,path from users where uid = '"+user.getUid()+"'";
			...
			while(rs.next()){
				...
				user.setImageName(rs.getString(10));
				user.setPath(rs.getString(11));	
			}
